...
{
    public const string ProductVersion = "0.2.6";
    ...
    public const string SupportedRange = "verified: 0.1.0-rc.8, 0.1.1-rc.2, 0.1.2-rc.1, 0.1.5-alpha.2, 0.1.5-rc.1, 0.1.5-rc.2, 0.1.6-alpha.2";
    public static readonly IReadOnlyList<string> VerifiedDshVersions = ["0.1.0-rc.8", "0.1.1-rc.2", "0.1.2-rc.1", "0.1.5-alpha.2", "0.1.5-rc.1", "0.1.5-rc.2", "0.1.6-alpha.2"];
