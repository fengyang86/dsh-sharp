...
{
    public const string ProductVersion = "0.2.2";
    public const string MinimumDshVersion = "0.1.0-rc.8";
    public const string MaximumDshVersionExclusive = "0.1.2";
    public const string DefaultDshVersion = "0.1.2-rc.1";
    public const string SupportedRange = "verified: 0.1.0-rc.8, 0.1.1-rc.2, 0.1.2-rc.1";
    public static readonly IReadOnlyList<string> VerifiedDshVersions = ["0.1.0-rc.8", "0.1.1-rc.2", "0.1.2-rc.1"];

    public static bool IsCompatible(string? version)
        => SemVersion.TryParse(version, out var parsed)
            && VerifiedDshVersions.Any(item => SemVersion.Parse(item).CompareTo(parsed) == 0);
